...
resultado_passo_frente <- data.frame(
...
resultado_passo_frente$volatilidade_forecast <- NA

for (i in 1:nrow(resultado_passo_frente)) {
  ticker <- resultado_passo_frente$ticker[i]
  m <- resultado_passo_frente$m[i]
  n <- resultado_passo_frente$n[i]
  dist <- resultado_passo_frente$dist[i]
  
  volatilidade <- prever_volatilidade(ticker, m, n, dist)
  resultado_passo_frente$volatilidade_forecast[i] <- volatilidade
}

print(resultado_passo_frente)
